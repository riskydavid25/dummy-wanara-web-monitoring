...
https://img.shields.io/badge/MQTT-Public%2520Broker-green.svg
...
Simulasi Kondisi Realistis:

Suhu, Kelembaban, dan Asap

Status: NORMAL, WARNING, FIRE_ALERT

Kualitas Jaringan (QoS): GOOD / POOR
...
Node	Taman Nasional	Lokasi	Provinsi
...
1. Clone Repository
bash
git clone https://github.com/yourusername/dummy-wanara-web-monitoring.git
...
Status Conditions:
Status	Temperature	Humidity	Smoke Level	Condition
NORMAL	24-42°C	45-90%	10-250 ppm	Kondisi normal
WARNING	≥65% anomaly	-	-	Potensi bahaya
...
python
# Di dalam fungsi generate_sensor_data():
fire_detected = random.random() < 0.08  # 8% chance
if random.random() < 0.01:              # 1% chance offline
🐛 Troubleshooting
MQTT Connection Failed
Pastikan internet terhubung

Coba ganti broker: broker.hivemq.com atau test.mosquitto.org

Data Tidak Masuk ke Dashboard
Periksa topic subscription: wanara/#

Pastikan QoS yang digunakan 1

Cek apakah broker menerima publish (cek log)

Deprecation Warning
text
DeprecationWarning: Callback API version 1 is deprecated
Abaikan warning ini, masih compatible dengan versi terbaru.
